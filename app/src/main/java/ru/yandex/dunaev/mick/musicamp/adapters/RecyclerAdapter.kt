...
import ru.yandex.dunaev.mick.musicamp.databinding.CardMusicBinding
import ru.yandex.dunaev.mick.musicamp.models.MusicSong

class MusicListAdapter : CategoryAdapter<MusicSong, CardMusicBinding>(
    R.layout.card_music
) {
    override fun onBindViewHolder(holder: CategoryHolder<CardMusicBinding>, position: Int) = with(holder.binding){
